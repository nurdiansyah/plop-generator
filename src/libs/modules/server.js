...
export const moduleServerGenerator = ({ plop, prompts }) => ({ actions = [], templateDir, path, data = {} }) => {
    const model = pascalCase(data.model), modulePackage = "server", rootPath = `${path}${data.isMonorepo ? `/${modulePackage}` : ""}`, srcPath = `${rootPath}/src`;
            ...
            return [
                {
                    ...
                    template: 'import { create{{ pascalCase model }}Schema } from "./{{ pascalCase model }}schema";',
                },
                {
                    type: "append",
                    path,
            ...
            return [
                {
                    ...
                    data,
                    pattern: getPatternRegex(),
                    template: 'import { create{{ pascalCase model }}ServiceServer } from "./{{ pascalCase model }}ServiceServer";',
                },
                {
                    type: "append",
                    path,
                ...
                },
                {
                    ...
                    template: 'export { get{{ pascalCase model }}ServiceServer, {{ pascalCase model }}ServiceServer, create{{ pascalCase model }}ServiceServer } from "./{{ pascalCase model }}ServiceServer";',
                },
            ];
        }
        return [
            ...
            return [
                {
                    ...
                    data,
                    pattern: getPatternRegex(),
                    template: 'import { create{{ pascalCase model }}Repo } from "./{{ pascalCase model }}Collection";',
                },
                {
                    type: "append",
                    path,
                ...
                },
                {
                    ...
                    template: 'export { {{ pascalCase model }}Collection, create{{ pascalCase model }}Repo } from "./{{ pascalCase model }}Collection";',
                },
            ];
        }
        return [
    ...
    actions.push(...graphqlActions, ...getIndexGraphqlAction(), ...serviceActions, ...getIndexServiceAction(), ...repoActions, ...getIndexRepoAction(), ...mongoActions, ...getIndexMongoAction());
    return actions;
};
